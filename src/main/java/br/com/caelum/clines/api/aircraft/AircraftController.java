...
public class AircraftController {
  ...
  @GetMapping("{code}")
  public AircraftView show(@PathVariable String code) {
    return service.showAircraftBy(normalize(code));
  }

  @GetMapping
  public List<AircraftView> list() {
    return service.listAllAircraft();
  }

  @PostMapping
  public ResponseEntity<Object> createBy(@RequestBody @Valid AircraftForm form) {
